    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="http://xuanzhongliang.oss-cn-shanghai.aliyuncs.com/1805091511357992.jpg" title="pic" />
                    </li>
                    <li>
    ...
    <div class="item-inform">
                ...
                <%--<ul class="tb-thumb" id="thumblist">--%>
                    <%--<li class="tb-selected">--%>
                        <%--<div class="tb-pic tb-s40">--%>
                            <%--<a href="#">--%>
                                <%--<img src="http://xuanzhongliang.oss-cn-shanghai.aliyuncs.com/1805091511357992.jpg" mid="http://xuanzhongliang.oss-cn-shanghai.aliyuncs.com/1805091511357992.jpg" big="http://xuanzhongliang.oss-cn-shanghai.aliyuncs.com/1805091511357992.jpg"></a>--%>
                        <%--</div>--%>
                    <%--</li>--%>
        ...
        <div class="clearfixRight">
            ...
            <div class="tb-detail-hd">
                ...
                <br>
                <span>出版社：${book.publishPlace}</span>
                <br>
                <span>折扣：${book.discount}折</span>
                <br>
                <span>电子书链接：
                    <c:if test="${eBook.eBookUrl != null}">
                        <a href="${eBook.eBookUrl}" target="_blank">点击这里</a>
                    </c:if>
                </span>
            </div>
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${book.currentPrice/100}</b></dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em>
                            <b class="sys_item_mktprice">${book.price/100}</b>
                        </dd>
                    </li>
                    <div class="clear"></div>
                </div>
                ...
                <dl class="iteminfo_parameter sys_item_specpara">
                    ...
                    <span>数量：</span>
                        ...
                        <input id="text_box" name="amount" type="text" value="1" style="width:40px;" />
                    ...
                    <div class="pay">
                        ...
                        <li>
                            <div class="clearfix tb-btn tb-btn-buy theme-login">
                                <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="javascript:buy('${book.id}');">立即购买</a>
                            </div>
                        </li>
                        <li>
                            <div class="clearfix tb-btn tb-btn-basket theme-login">
                                <a id="LikBasket" title="加入购物车" href="javascript:addToCart('${book.id}');"><i></i>加入购物车</a>
                            </div>
                        </li>
                    </div>
                </dl>
            ...
            <div class="am-tabs-bd">
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    <div class="J_Brand">
                        ...
                        <div class="clear"></div>
                        <ul id="J_AttrUL">
                            <li title="">版次:&nbsp;${bookParam.bookEdition}</li>
                            <li title="">页数:&nbsp;${bookParam.bookPage}</li>
                            <li title="">字数:&nbsp;${bookParam.bookWords}</li>
                            <li title="">包装:&nbsp;${bookParam.bookPack}</li>
                            <li title="">国际标准书号ISBN:&nbsp;${book.isbn}</li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="am-tab-panel am-fade">
                    ...
                    <div class="tb-reviewsft">
                        <div class="tb-rate-alert type-attention">没有更多评论了</div>
                    </div>
...
<script>
    function buy(bookId){
        var buyAmount = $('input[name=amount]').val();
        console.log("buy book" + buyAmount);
    }

    function addToCart(bookId){
        var cartAmount = $('input[name=amount]').val();
        console.log("cart book" + cartAmount);
        $.ajax({
            type:'post',
